...
class alignas(VL_CACHE_LINE_BYTES) Vtop_tb_cpu_midcore final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        VL_IN8(__PVT__exec_mispredict_rob_idx,3,0);
        VL_IN8(__PVT__rdPtr_i,3,0);
        VL_IN8(__PVT__checkpoint_full,0,0);
        VL_IN8(__PVT__cp_checkpoint_id_i,1,0);
        ...
        VL_OUT8(__PVT__cp_dispatch_rob_idx,3,0);
        VL_OUT8(__PVT__cp_rename_update_o,0,0);
        VL_OUT8(__PVT__cp_rename_update_pr_o,5,0);
        ...
        VL_IN64(__PVT__recover_alloc_list_i,63,0);
    };
    struct {
        VL_IN64(__PVT__bt_rebuild_i,63,0);
        VL_OUTW(__PVT__ROB_midcore_o,370,0,12);
        VL_OUT64(__PVT__MIDCORE_midcore_o,57,0);
        VlWide<12>/*370:0*/ __PVT__ROB_decode_o;
        VlWide<12>/*370:0*/ __PVT__ROB_rename1_o;
        VlWide<12>/*370:0*/ __PVT__ROB_rename2_o;
        VlWide<12>/*370:0*/ __PVT__ROB_rename1_reg;
        VlWide<12>/*370:0*/ __PVT__ROB_rename2_reg;
        ...
        VL_IN8(__PVT__recover_srat_i[32],5,0);
        VL_OUT8(__PVT__cp_dispatch_srat[32],5,0);
        VlUnpacked<CData/*5:0*/, 32> __PVT__srat_o;
