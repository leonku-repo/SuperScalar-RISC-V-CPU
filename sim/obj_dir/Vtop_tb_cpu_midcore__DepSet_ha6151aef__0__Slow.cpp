...
VL_ATTR_COLD void Vtop_tb_cpu_midcore___ctor_var_reset(Vtop_tb_cpu_midcore* vlSelf) {
    ...
    vlSelf->__PVT__wb_alu_pr = VL_RAND_RESET_I(6);
    vlSelf->__PVT__wb_load_pr = VL_RAND_RESET_I(6);
    vlSelf->__PVT__wb_jump_pr = VL_RAND_RESET_I(6);
    vlSelf->__PVT__wb_cmp_pr = VL_RAND_RESET_I(6);
    vlSelf->__PVT__wb_mul_pr = VL_RAND_RESET_I(6);
    ...
    vlSelf->__PVT__MIDCORE_rename1_reg = VL_RAND_RESET_Q(58);
    ...
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->__PVT__srat__DOT__srat[__Vi0] = VL_RAND_RESET_I(6);
    }
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->__PVT__srat__DOT__srat_next[__Vi0] = VL_RAND_RESET_I(6);
    }
    vlSelf->__PVT__srat__DOT__unnamedblk1__DOT__i = 0;
    vlSelf->__PVT__busy_table__DOT__bt = VL_RAND_RESET_Q(64);
