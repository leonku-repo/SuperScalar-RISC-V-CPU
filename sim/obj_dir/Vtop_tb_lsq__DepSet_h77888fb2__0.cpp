...
VL_INLINE_OPT void Vtop_tb_lsq___ico_sequent__TOP__top_tb__dut__cpu_execute__lsq__0(Vtop_tb_lsq* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_tb_lsq___ico_sequent__TOP__top_tb__dut__cpu_execute__lsq__0\n"); );
    // Init
