...
VL_ATTR_COLD void Vtop_tb_top_tb___stl_sequent__TOP__top_tb__1(Vtop_tb_top_tb* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vtop_tb_top_tb___stl_sequent__TOP__top_tb__1\n"); );
    // Body
    ...
    if ((0x8000000U & vlSymsp->TOP__top_tb__dut.__PVT__commit_rob_o[7U])) {
    ...
    if ((0x10000000U & vlSymsp->TOP__top_tb__dut.__PVT__commit_rob_o[7U])) {
